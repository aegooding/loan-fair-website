...
- Name: enquiry-form.spec.js >> happy path — personal loan enquiry submits successfully
- Location: tests/enquiry-form.spec.js:89:5
    ...
    - generic [ref=e101]:
      ...
      - generic [ref=e104]:
        - generic [ref=e105]:
          ...
          - textbox "Occupation *" [ref=e107]: Teacher
        - generic [ref=e108]:
          - generic [ref=e109]: Employer name
          - textbox "Employer name" [active] [ref=e110]: Department of Education
      - generic [ref=e111]:
